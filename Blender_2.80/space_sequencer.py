...
# ========================= OPEN NEW BLOCK =========================
# In SEQUENCER
# Adds (a) 'Refresh Sequencer' button; (b) information about VSE 
# project resolution | project FPS | timeline length (in SMPTE)
        ...
        #----------------------------------------------
        # Project resolution | FPS | Timeline length
        #----------------------------------------------
#        if st.view_type in {'PREVIEW', 'SEQUENCER_PREVIEW'}:
        if st.view_type in {'SEQUENCER'}:
            layout.separator_spacer()
            layout.operator("sequencer.refresh_all")
            layout.label(text="%s x %s | %s FPS | %s" % (rd.resolution_x, rd.resolution_y, fps,
                                                        smpte(scene.frame_end - scene.frame_start)))
#            row.label(text="%s x %s | %s FPS" % (rd.resolution_x, rd.resolution_y, fps))
...
# ========================= OPEN NEW BLOCK =========================
# Adds strip resolution information below strip name in VSE sidebar
# and button to set project render size according to strip resolution
...
#                # Current element for the filename.
            ...
            #----------------------------------------------
            # Button "Set Render Size"
            #----------------------------------------------
            if strip_type == 'MOVIE' or strip_type == 'IMAGE':
                layout.operator("sequencer.rendersize")
